...
ax1[0].plot(determinist[0], determinist[1], label="Deterministic", c="red", linestyle='--', marker='s', markersize=3.0)
ax1[0].plot(exponential[0], exponential[1], label="Exponential", c="black", linestyle='--', marker='s', markersize=3.0)
